---
{"dg-publish":true,"permalink":"//kstation-master/","dg-note-properties":{}}
---
...
01_제품전략_핵심.md
        ↓ 방향 제시
신제품/01_리서치/01_커뮤니티_페인포인트.md
        ↓
신제품/02_제품설계/01_스펙시트.md  ←→  02_OEM_QA_프로토콜.md (OEM 협의)
        ↓ OEM [Confirmed] 항목만
신제품/03_마케팅/02_커뮤니티_언어뱅크.md
        ↓
신제품/03_마케팅/03_론칭_시퀀스.md
        ↓
신제품/05_로그/ (전 단계 기록)
```
